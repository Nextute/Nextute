    ...
    <div className="flex flex-col h-16 sm:h-20 sm:flex-row items-center justify-between mt-6 sm:mt-10 w-full max-w-md md:max-w-lg lg:max-w-4xl mx-auto shadow-custom border border-[#000000] rounded-full overflow-hidden">
      ...
      <div className="flex items-center gap-2 px-6 py-2 w-full mt-3 sm:mt-0">
        ...
        <input
          ...
          className="outline-none bg-[#FFFFFF] w-full text-gray-700 placeholder-[#000] placeholder-opacity-90 text-sm sm:text-base placeholder:text-sm sm:placeholder:text-base rounded-md"
          value={query}
      ...
      <div className="relative h-full w-full flex items-center justify-center px-6 py-2">
        <div className="relative flex items-center justify-center">
          ...
          <button onClick={handleSearch}>
            <Search className="absolute max-sm:bottom-3 -bottom-2 translate-x-44 min-md:translate-x-24 size-6 text-white z-10 max-sm:text-[#204B55] max-sm:translate-x-40 cursor-pointer" />
          </button>
        </div>
      </div>
    </div>
