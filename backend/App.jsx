  ...
  return (
    <div className="h-screen">
      <Routes>
        ...
        <Route path="/institute/student-achievements" element={<StudentAchievementsPage />} />
        <Route path="/institute/institute-achievements" element={<InstituteAchievementsPage />} />
